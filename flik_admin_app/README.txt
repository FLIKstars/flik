...
flik_admin_app/flik_admin_app/my/
...
flik_admin_app/flik_admin_app/common/
  ...
  * Project wise unit tests
  ...
  Put this app in the first element of INSTALLED_APPS so that it takes priority for processing, like this:
	...
	INSTALLED_APPS = (
	    'flik_admin_app.common',  # <-- Put it here to override `admin` app's template and static files
