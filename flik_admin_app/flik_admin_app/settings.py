"""
Django settings for flik_admin_app project.
...
SECRET_KEY = '@5tl=cb%o_^dbxza_e!yn8)dhky=*8&i@veb1m0je2z^ru5dva'
...
ROOT_URLCONF = 'flik_admin_app.urls'

WSGI_APPLICATION = 'flik_admin_app.wsgi.application'
